...
public class Alerting {
    ...
    static final Logger LOGGER = LoggerFactory.getLogger(Alerting.class);
    final String TIMER_NAME = "ALERTING";
    Timer timer = null;
    ...
    public void execute(Timer timer) {
        ...
        try {
            ...
            String result = Utils.doGet(api + "/heartbeat/alertsProcessing", 30, true);
