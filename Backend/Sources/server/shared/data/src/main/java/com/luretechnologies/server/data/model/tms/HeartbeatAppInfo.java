...
public class HeartbeatAppInfo implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HeartbeatAppInfo)) {
            return false;
        }
        HeartbeatAppInfo other = (HeartbeatAppInfo) object;
        return !((this.id == null && other.id != null) || (this.id != null && !this.id.equals(other.id)));
    }

    @Override
    public String toString() {
        return "com.luretechnologies.server.data.model.tms.HeartbeatAppInfo[ id=" + getId() + " ]";
    }
