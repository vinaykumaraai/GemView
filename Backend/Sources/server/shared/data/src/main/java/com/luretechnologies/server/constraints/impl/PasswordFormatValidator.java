...
public class PasswordFormatValidator implements ConstraintValidator<PasswordFormat, User> {
     ...
     */
    @Override
    public void initialize(final PasswordFormat constraintAnnotation) {
    }
    ...
    public boolean isValid(final User user, final ConstraintValidatorContext context) {
        ...
        return Utils.isValidSHA2(password);
    }
}
