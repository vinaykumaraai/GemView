...
import com.luretechnologies.server.data.dao.ParameterDAO;
...
//    @Override
//    public List<Parameter> search(String filter, int firstResult, int maxResult) throws PersistenceException {
