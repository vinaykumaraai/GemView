 ...
 */
@Repository
public class SystemParamsTypeDAOImpl extends BaseDAOImpl<SystemParamType, Long> implements SystemParamsTypeDAO {

    @Override
    public List<SystemParamType> search(String filter, int firstResult, int lastResult) throws PersistenceException {

        CriteriaQuery<SystemParamType> cq = criteriaQuery();
        Root<SystemParamType> root = getRoot(cq);
    ...
    @Override
    public SystemParamType getByName(String name) throws PersistenceException {
        return (SystemParamType) findByProperty("name", name).getSingleResult();
    }
