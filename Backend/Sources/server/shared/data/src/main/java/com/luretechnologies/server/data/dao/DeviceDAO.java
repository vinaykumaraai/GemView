...
public interface DeviceDAO extends BaseDAO<Device, Long> {
    ...
    /**
     * Returns terminals which contains entities matching a filter. Search deep
     * in the tree
     *
     * @param filter
     * @param firstResult
     ...
     * @throws PersistenceException
     */
//    public List<Device> searchTree(String filter, int firstResult, int maxResult) throws PersistenceException;
}
