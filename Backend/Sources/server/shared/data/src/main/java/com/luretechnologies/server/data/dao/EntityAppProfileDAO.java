...
public interface EntityAppProfileDAO extends BaseDAO<EntityAppProfile, Long>{
     ...
     * @return
     */
    public List<EntityAppProfile> getEntityAppProfileList(List<Long> ID) throws PersistenceException;
