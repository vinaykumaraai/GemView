 ...
 */
@Repository
public class UserLastPasswordDAOImpl extends BaseDAOImpl<UserLastPassword, Long> implements UserLastPasswordDAO {
    
    private static final Logger LOGGER = LoggerFactory.getLogger(UserLastPasswordDAO.class);

    @Override
    public UserLastPassword findByUserId(Long userId) {
        return (UserLastPassword) findByProperty("user", userId).getSingleResult(); 
    }
