 ...
 * @author
 */
public interface SystemParamsDAO extends BaseDAO<SystemParam, Long> {
     ...
     */
    public List<SystemParam> search(String filter, int pageNumber, int rowsPerPage) throws PersistenceException;
