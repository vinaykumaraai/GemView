...
public class ActionDAOImpl extends BaseDAOImpl<Action, Long> implements ActionDAO{
    ...
    @Override
    public List<Action> getActionList(List<Long> IDS)throws PersistenceException{
        List<Action> actionList = new ArrayList<>();
        for(Long ID : IDS) {
            actionList.add(getEntityManager().find(Action.class, ID));
        }
        return actionList;
    }
     ...
     */
    @Override
    public Action getActionByID(Long ID) throws PersistenceException{
       return  getEntityManager().find(Action.class, ID);
