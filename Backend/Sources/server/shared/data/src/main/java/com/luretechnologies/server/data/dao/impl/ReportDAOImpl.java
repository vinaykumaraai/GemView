...
import com.luretechnologies.server.data.dao.ReportDAO;
import com.luretechnologies.server.data.model.Report;
...
//    @Override
//    public List<Report> search(String search, int firstResult, int maxResult) throws PersistenceException {
