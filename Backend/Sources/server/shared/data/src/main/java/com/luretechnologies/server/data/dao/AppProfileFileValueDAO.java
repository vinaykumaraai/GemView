 ...
 * @author Vinay
 */
public interface AppProfileFileValueDAO extends BaseDAO<AppProfileFileValue, Long>{
     ...
     * @return
     */
    public List<AppProfileFileValue> getAppProfileFileList(List<Long> ID)throws PersistenceException;
