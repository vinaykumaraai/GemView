 ...
 */
@Repository
public class DebugDAOImpl extends BaseDAOImpl<Debug, Long> implements DebugDAO {

    @Override
    public List<Debug> search(Long entityId, int firstResult, int lastResult) throws PersistenceException {

        CriteriaQuery<Debug> cq = criteriaQuery();
        Root<Debug> root = getRoot(cq);
