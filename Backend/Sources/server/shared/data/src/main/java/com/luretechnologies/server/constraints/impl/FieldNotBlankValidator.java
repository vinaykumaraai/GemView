 ...
 * @author developer
 */
public final class FieldNotBlankValidator implements ConstraintValidator<FieldNotBlank, CharSequence> {
     ...
     */
    @Override
    public void initialize(final FieldNotBlank constraintAnnotation) {
    }
