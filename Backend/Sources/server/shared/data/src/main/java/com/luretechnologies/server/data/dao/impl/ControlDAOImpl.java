...
import com.luretechnologies.server.data.dao.ControlDAO;
import com.luretechnologies.server.data.model.survey.Control;
...
//    @Override
//    public List<Control> searchControls(String search, int firstResult, int maxResult) throws PersistenceException {
...
//                    .add(Restrictions.like("abbr", search, MatchMode.ANYWHERE).ignoreCase());
