...
public class GroupDAOImpl extends BaseDAOImpl<Group, Long> implements GroupDAO {
    ...
    @Override
    public Group findByName(String name) throws PersistenceException {
        try {
            return (Group) findByProperty("name", name).getSingleResult();
        } catch (NoResultException e) {
            LOGGER.info("Group not found. name: " + name, e);
            return null;
        }
    }

    @Override
    public List<Group> list(String name, int firstResult, int lastResult) throws PersistenceException {
        CriteriaQuery<Group> q = criteriaQuery();
        Root<Group> root = getRoot(q);
    ...
    @Override
    public List<Group> search(String filter, int firstResult, int lastResult) throws PersistenceException {
    ...
    @Override
    public List<Group> list(int firstResult, int lastResult) throws PersistenceException {
