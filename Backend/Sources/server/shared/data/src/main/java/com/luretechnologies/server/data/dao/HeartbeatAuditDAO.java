 ...
 * @author
 */
public interface HeartbeatAuditDAO extends BaseDAO<HeartbeatAudit, Long> {
     ...
     * @throws PersistenceException
     */
    public List<HeartbeatAudit> search(Long entityId, String filter, int pageNumber, int rowsPerPage, Date dateFrom, Date dateTo) throws PersistenceException;
