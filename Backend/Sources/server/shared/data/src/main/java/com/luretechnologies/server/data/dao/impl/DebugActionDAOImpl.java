 ...
 */
@Repository
public class DebugActionDAOImpl extends BaseDAOImpl<DebugAction, Long> implements DebugActionDAO {

    @Override
    public List<DebugAction> search(Long entityId, String filter, int firstResult, int lastResult) throws PersistenceException {

        CriteriaQuery<DebugAction> cq = criteriaQuery();
        Root<DebugAction> root = getRoot(cq);
    ...
    public void delete(Long id) throws PersistenceException {
        DebugAction debugAction = findById(id);
