 ...
 */
@Repository
public class TelephoneDAOImpl extends BaseDAOImpl<Telephone, Long> implements TelephoneDAO {

    private static final Logger LOGGER = LoggerFactory.getLogger(TelephoneDAOImpl.class);

    @Override
    public List<Telephone> getTelephonesNoRelations(Collection<Telephone> excludes) {
        ...
        for (Telephone exclude : excludes) {
    ...
    @Override
    public List<Telephone> getTelephonesNoRelations() {
        return getTelephonesNoRelations(new ArrayList<Telephone>());
    }
