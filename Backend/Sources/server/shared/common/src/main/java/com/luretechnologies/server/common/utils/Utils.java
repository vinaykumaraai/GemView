...
//    private static final Hashids hashIds = new Hashids(HASHIDS_SECRET_KEY, 10, alpha_lowercase + alpha_uppercase + numeric);
    ...
    public static String doGet(String urlToRead) {
        return doGet(urlToRead, 30000);
    }

    public static String doGet(String urlToRead, int timeout, boolean minutes) {
        return doGet(urlToRead, minutes ? timeout * (int) MS_MINUTE : timeout);
    }

    public static String doGet(String urlToRead, int timeoutMs) {
