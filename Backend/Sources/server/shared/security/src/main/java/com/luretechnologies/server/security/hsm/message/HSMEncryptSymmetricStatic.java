 ...
 * @author developer
 */
public class HSMEncryptSymmetricStatic extends HSMMessageBuilder {
     ...
     *
     */
    protected DataLength clearBlockLength;

    /**
     *
     */
    public HSMParameter clearBlock;

    /**
     *
     */
    public HSMEncryptSymmetricStatic() {
        command.encryptSymmetric();
        ...
        clearBlock = new HSMParameter("Clear Block");
        clearBlockLength = new DataLength(clearBlock);
        ...
        addParameter(clearBlockLength);
        addParameter(clearBlock);

        clearBlockLength.hex();
    }
