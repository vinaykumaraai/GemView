...
public class AppProfileController {
    ...
    public AppProfile create(@RequestBody AppProfile appProfile) throws Exception {
    ...
    public AppProfile updateAppFile(
            @ApiParam(value = "AppProfile id", required = true) @PathVariable("id") long id,
            @ApiParam(value = "AppProfile object", required = true) @RequestBody AppProfile appProfile) throws Exception {
    ...
    public AppProfile getAppFileByID(@ApiParam(value = "AppProfile ID", required = true) @PathVariable long id) throws Exception {
    ...
    public List<AppProfile> getAppFileList(@ApiParam(value = "AppProfile ID", required = true) @PathVariable List<Long> ids) throws Exception {
