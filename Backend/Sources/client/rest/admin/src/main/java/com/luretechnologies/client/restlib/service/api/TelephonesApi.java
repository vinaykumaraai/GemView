...
public class TelephonesApi extends BaseApi {
     ...
     */
    public Telephone create(Telephone telephone) throws ApiException {
        Object postBody = telephone;
        byte[] postBinaryBody = null;

        String path = "/telephone/create".replaceAll("\\{format\\}", "json");
        ...
        TypeRef returnType = new TypeRef<Telephone>() {
        };
