...
public class AppProfileParamValue {
    ...
    public String toString() {
        ...
        sb.append("class AppProfileParamValue {\n");
        ...
        sb.append("    appParamId: ").append(StringUtil.toIndentedString(getAppParamId())).append("\n");
        sb.append("}");
        return sb.toString();
    }
