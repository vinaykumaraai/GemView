...
public class AppParamFormatApi extends BaseApi {

    private static final String METHOD_GET = "/appparamformat/{id}";

    /**
     * @param apiClient
     */
    public AppParamFormatApi(ApiClient apiClient) {
        super(apiClient);
    }
     ...
     *
     * @param id AppParamFormat id
     * @return AppParamFormat
     * @throws com.luretechnologies.client.restlib.common.ApiException
     */
    public AppParamFormat getAppParamFormat(Long id) throws ApiException {
        ...
        TypeRef returnType = new TypeRef<AppParamFormat>() {
        };
