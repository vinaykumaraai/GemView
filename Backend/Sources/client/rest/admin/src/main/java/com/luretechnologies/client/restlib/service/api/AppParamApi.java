...
public class AppParamApi extends BaseApi {

    private static final String METHOD_GET = "/appparam/{id}";
    private static final String METHOD_LIST = "/appparam";

    /**
     * @param apiClient
     */
    public AppParamApi(ApiClient apiClient) {
        super(apiClient);
    }

    /**
     * Get AppParam Get AppParam by id
     *
     * @param id AppParam id
     * @return AppParam
     * @throws com.luretechnologies.client.restlib.common.ApiException
     */
    public AppParam getAppParam(Long id) throws ApiException {
        ...
        TypeRef returnType = new TypeRef<AppParam>() {
        };
    ...
    /**
     * Get all AppParam. Will return 50 records if no paging parameters defined
     *
     * @return AppParam list
     * @throws com.luretechnologies.client.restlib.common.ApiException
     */
    public List<AppParam> getAppParams() throws ApiException {
        Object postBody = null;
        byte[] postBinaryBody = null;
