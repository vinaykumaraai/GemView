...
public class EntityLevelApi extends BaseApi {

    private static final String METHOD_GET = "/entitylevel/{id}";

    /**
     * @param apiClient
     */
    public EntityLevelApi(ApiClient apiClient) {
        super(apiClient);
    }
     ...
     *
     * @param id EntityLevel id
     * @return EntityLevel
     * @throws com.luretechnologies.client.restlib.common.ApiException
     */
    public EntityLevel getEntityLevel(Long id) throws ApiException {
        ...
        TypeRef returnType = new TypeRef<EntityLevel>() {
        };
