...
public class AppFileApi extends BaseApi {

    private static final String METHOD_LIST = "/appfile";

    /**
     * @param apiClient
     */
    public AppFileApi(ApiClient apiClient) {
        super(apiClient);
    }
    
    /**
     * Get all appFiles. Will return 50 records if no paging parameters defined
     *
     * @return AppFiles list
     * @throws com.luretechnologies.client.restlib.common.ApiException
     */
    public List<AppFile> getAppFiles() throws ApiException {
