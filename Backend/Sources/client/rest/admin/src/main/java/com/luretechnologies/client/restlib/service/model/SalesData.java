...
public class SalesData {
    ...
    public String toString() {
        ...
        sb.append("class SalesData {\n");

        sb.append("    saleCount: ").append(StringUtil.toIndentedString(saleCount)).append("\n");
        sb.append("    voidCount: ").append(StringUtil.toIndentedString(voidCount)).append("\n");
        sb.append("    saleAmount: ").append(StringUtil.toIndentedString(saleAmount)).append("\n");
        sb.append("}");
        return sb.toString();
    }
}
