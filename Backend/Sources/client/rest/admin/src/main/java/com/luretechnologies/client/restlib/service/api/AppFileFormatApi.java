...
public class AppFileFormatApi extends BaseApi {

    private static final String METHOD_GET = "/appfileformat/{id}";

    /**
     * @param apiClient
     */
    public AppFileFormatApi(ApiClient apiClient) {
        super(apiClient);
    }

    /**
     * Get appfileformat Get appfileformat by id
     *
     * @param id Appfileformat id
     * @return Appfileformat
     * @throws com.luretechnologies.client.restlib.common.ApiException
     */
    public AppFileFormat getAppFileFormat(Long id) throws ApiException {
        ...
        TypeRef returnType = new TypeRef<AppFileFormat>() {
        };
