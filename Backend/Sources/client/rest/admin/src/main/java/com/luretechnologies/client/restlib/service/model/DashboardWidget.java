...
public class DashboardWidget {
    ...
    private List<DashboardCurrentDownLoads> currentDownLoadsDisplays;
     ...
     */
    public List<DashboardCurrentDownLoads> getCurrentDownLoadsDisplays() {
     ...
     */
    public void setCurrentDownLoadsDisplays(List<DashboardCurrentDownLoads> currentDownLoadsDisplays) {
