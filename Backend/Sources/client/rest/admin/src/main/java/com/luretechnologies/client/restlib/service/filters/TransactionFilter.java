...
public class TransactionFilter extends BaseFilter {
    ...
    public static final String TIP_AMMOUNT = "tipAmount";
    public static final String AUTHORIZED_AMMOUNT = "authorizedAmount";
    public static final String TOTAL_AMMOUNT = "totalAmount";
