...
public class UserSession {
    ...
    private final boolean performTwoFactor;
    private final boolean requirePasswordUpdate;

    public UserSession(LoginResponse loginResponse) {
        this.maskedEmailAddress = loginResponse.getMaskedEmailAddress();
        this.performTwoFactor = loginResponse.isPerformTwoFactor();
        this.requirePasswordUpdate = loginResponse.isRequirePasswordUpdate();
    }

    public UserSession(String maskedEmailAddress, boolean performTwoFactor, boolean requirePasswordUpdate) {
