...
public class AlertActionTest {
    ...
    @Test
    public void createAndUpdateAlertAction() {
        try {
            ...
            alertAction.setAvailable(false);
            alertAction = service.getAlertActionApi().update(alertAction );
            assertNotNull(alertAction);
            System.out.println(alertAction.toString());
            alertAction.setAvailable(true);
            alertAction = service.getAlertActionApi().update(alertAction );
            assertNotNull(alertAction);
            System.out.println(alertAction.toString());
    ...
    public void searchAndDelete() {
        try {
            ...
            for (AlertAction temp : alertActionList) {
