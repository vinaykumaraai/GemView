...
public enum AddressTypeEnum {
    ...
    private static final Map<Integer, AddressTypeEnum> map = new HashMap<>();

    AddressTypeEnum(Integer id, String name, String description) {
        this.id = id;
        this.name = name;
    ...
    static {
        for (AddressTypeEnum addressTypeEnum : AddressTypeEnum.values()) {
            map.put(addressTypeEnum.getId(), addressTypeEnum);
        }
    }
     ...
     * @return
     */
    public static final AddressTypeEnum getAddressTypeEnum(Integer id) {
        if (id != null) {
            return map.get(id);
        } else {
            return null;
