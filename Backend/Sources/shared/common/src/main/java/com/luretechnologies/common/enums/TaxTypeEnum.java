...
public enum TaxTypeEnum {
    ...
    private static final Map<Integer, TaxTypeEnum> map = new HashMap<>();

    TaxTypeEnum(Integer id) {
        this.id = id;
    }
    ...
    static {
        for (TaxTypeEnum taxTypeEnum : TaxTypeEnum.values()) {
            map.put(taxTypeEnum.getId(), taxTypeEnum);
        }
    }
     ...
     * @return
     */
    public static final TaxTypeEnum getTaxTypeEnum(Integer id) {
        return map.get(id);
    }
}
