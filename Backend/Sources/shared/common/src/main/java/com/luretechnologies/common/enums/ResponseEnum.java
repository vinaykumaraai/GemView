...
public enum ResponseEnum {
     ...
     *
     */
    APPROVED_LESSER(10, "APPROVED LESSER"),
    /**
     *
     */
    ...
    private static final Map<Integer, ResponseEnum> map = new HashMap<>();

        
    ResponseEnum(Integer id, String defaultMessage) {
        this.id = id;
        this.defaultMessage = defaultMessage;
        this.statusCode = String.format("%02d", id);
    }
    
    ResponseEnum(Integer id, String defaultMessage, String statusCode) {
        this.id = id;
        this.defaultMessage = defaultMessage;
    ...
    static {
        for (ResponseEnum statusEnum : ResponseEnum.values()) {
     ...
     * @return
     */
    public static final ResponseEnum getStatusEnum(Integer id) {
        if (id != null) {
            return map.get(id);
        } else {
            return null;
