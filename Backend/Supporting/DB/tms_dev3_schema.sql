...
--
-- Host: localhost    Database: tms_dev3
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 COMMENT='Store addresses.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `app` (
  ...
  PRIMARY KEY (`id`),
  KEY `owner` (`owner_id`),
  CONSTRAINT `app_ibfk_1` FOREIGN KEY (`owner_id`) REFERENCES `entity` (`id`)
...
CREATE TABLE `app_file` (
  ...
  `description` varchar(128) DEFAULT NULL,
  `app_file_format` bigint(20) NOT NULL,
  `default_value` varchar(256) NOT NULL DEFAULT 'Path of the file',
  `modifiable` tinyint(1) NOT NULL DEFAULT '1',
  `force_update` tinyint(1) NOT NULL DEFAULT '0',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `AppFile_fk0` (`app`),
  KEY `AppFile_fk1` (`app_file_format`),
  CONSTRAINT `AppFile_fk0` FOREIGN KEY (`app`) REFERENCES `app` (`id`),
  CONSTRAINT `AppFile_fk1` FOREIGN KEY (`app_file_format`) REFERENCES `app_file_format` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `app_file_format`
--

DROP TABLE IF EXISTS `app_file_format`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `app_file_format` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `app_param` (
  ...
  `app` bigint(20) NOT NULL,
  `description` varchar(128) DEFAULT NULL,
  `entity_level` bigint(20) DEFAULT NULL,
  `app_param_format` bigint(20) NOT NULL,
  ...
  KEY `AppParam_fk1` (`entity_level`),
  KEY `AppParam_fk2` (`app_param_format`),
  KEY `AppParam_fk3` (`action`),
  CONSTRAINT `AppParam_fk0` FOREIGN KEY (`app`) REFERENCES `app` (`id`),
  CONSTRAINT `AppParam_fk1` FOREIGN KEY (`entity_level`) REFERENCES `entity_level` (`id`),
  CONSTRAINT `AppParam_fk2` FOREIGN KEY (`app_param_format`) REFERENCES `app_param_format` (`id`),
  CONSTRAINT `AppParam_fk3` FOREIGN KEY (`action`) REFERENCES `action` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `app_param_format`
--

DROP TABLE IF EXISTS `app_param_format`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `app_param_format` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `app_profile_file_value`
--

DROP TABLE IF EXISTS `app_profile_file_value`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `app_profile_file_value` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `app_profile` bigint(20) NOT NULL,
  `app_file` bigint(20) NOT NULL,
  `default_value` varchar(256) NOT NULL DEFAULT 'filename',
  `force_update` tinyint(1) NOT NULL DEFAULT '0',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `AppProfileFileValue_fk0` (`app_profile`),
  KEY `AppProfileFileValue_fk1` (`app_file`),
  CONSTRAINT `AppProfileFileValue_fk0` FOREIGN KEY (`app_profile`) REFERENCES `app_profile` (`id`),
  CONSTRAINT `AppProfileFileValue_fk1` FOREIGN KEY (`app_file`) REFERENCES `app_file` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `app_profile_param_value`
--

DROP TABLE IF EXISTS `app_profile_param_value`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `app_profile_param_value` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `app_profile` bigint(20) NOT NULL,
  `app_param` bigint(20) NOT NULL,
  `default_value` varchar(512) DEFAULT NULL,
  `force_update` tinyint(4) NOT NULL DEFAULT '0',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `app_profile_value_fk0` (`app_profile`),
  KEY `app_profile_value_fk1` (`app_param`),
  CONSTRAINT `app_profile_value_fk0` FOREIGN KEY (`app_profile`) REFERENCES `app_profile` (`id`),
  CONSTRAINT `app_profile_value_fk1` FOREIGN KEY (`app_param`) REFERENCES `app_param` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `appliance_app`
--

DROP TABLE IF EXISTS `appliance_app`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `appliance_app` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `ApplianceApp_fk0` FOREIGN KEY (`AppProfile`) REFERENCES `app_profile` (`id`),
...
--
-- Table structure for table `appliance_app_file_value`
--

DROP TABLE IF EXISTS `appliance_app_file_value`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `appliance_app_file_value` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `ApplianceAppFileValue_fk0` FOREIGN KEY (`ApplianceApp`) REFERENCES `appliance_app` (`id`),
  CONSTRAINT `ApplianceAppFileValue_fk1` FOREIGN KEY (`AppProfileFileValue`) REFERENCES `app_profile_file_value` (`app_profile`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `appliance_app_param_value`
--

DROP TABLE IF EXISTS `appliance_app_param_value`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `appliance_app_param_value` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `ApplianceApp` bigint(20) NOT NULL,
  ...
  CONSTRAINT `ApplianceAppParamValue_fk0` FOREIGN KEY (`ApplianceApp`) REFERENCES `appliance_app` (`id`),
  CONSTRAINT `ApplianceAppParamValue_fk1` FOREIGN KEY (`AppProfileParamValue`) REFERENCES `app_profile_param_value` (`app_profile`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `audit_user_log` (
  ...
  `audit_user_log_type` bigint(20) NOT NULL,
  `entity` bigint(20) DEFAULT NULL,
  `audit_action` bigint(20) NOT NULL,
  `details` varchar(512) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id_idx` (`user`),
  KEY `audit_user_log_type_idx` (`audit_user_log_type`),
  KEY `action_idx` (`audit_action`),
  CONSTRAINT `action` FOREIGN KEY (`audit_action`) REFERENCES `audit_action` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `type` FOREIGN KEY (`audit_user_log_type`) REFERENCES `audit_user_log_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `user` FOREIGN KEY (`user`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=540 DEFAULT CHARSET=utf8 COMMENT='Audit is to report all activities of the system and all user accounts.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `audit_user_log_type`
--

DROP TABLE IF EXISTS `audit_user_log_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `audit_user_log_type` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `ca_key`
--

DROP TABLE IF EXISTS `ca_key`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ca_key` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Database identification.',
...
--
-- Table structure for table `ca_key_profile`
--

DROP TABLE IF EXISTS `ca_key_profile`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ca_key_profile` (
  ...
  CONSTRAINT `FKCAKey_Prof27687` FOREIGN KEY (`cakey`) REFERENCES `ca_key` (`id`),
...
CREATE TABLE `data` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stores sensitive information.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `download` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'The database identifier.',
  `download_id` binary(16) NOT NULL COMMENT 'Download identification.',
  `terminal` bigint(20) NOT NULL COMMENT 'The terminal that performed the download.',
  `status` int(2) NOT NULL COMMENT 'The status of the download.',
  `length_ms` int(11) DEFAULT NULL COMMENT 'The current or total time in milliseconds of the download.',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Download''s creation date.',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Download''s last update date.',
  PRIMARY KEY (`id`),
  UNIQUE KEY `download_id` (`download_id`),
  KEY `FKTransactio233008` (`terminal`),
  CONSTRAINT `FKTransactio233008` FOREIGN KEY (`terminal`) REFERENCES `terminal` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stores download information.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `download_info` (
  ...
  `ftps_url` varchar(256) DEFAULT NULL,
...
--
-- Table structure for table `entity_app_profile`
--

DROP TABLE IF EXISTS `entity_app_profile`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `entity_app_profile` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `entity` bigint(20) NOT NULL,
  `app_profile` bigint(20) NOT NULL,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `app_profile` (`app_profile`),
  KEY `entity` (`entity`),
  CONSTRAINT `entity_app_profile_ibfk_2` FOREIGN KEY (`app_profile`) REFERENCES `app_profile` (`id`),
  CONSTRAINT `entity_app_profile_ibfk_3` FOREIGN KEY (`entity`) REFERENCES `entity` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `entity_app_profile_param`
--

DROP TABLE IF EXISTS `entity_app_profile_param`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `entity_app_profile_param` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `entity_app_profile` bigint(20) NOT NULL,
  `app_profile_param_value` bigint(20) NOT NULL,
  `value` varchar(256) DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `app_profile_param` (`app_profile_param_value`),
  KEY `entity_app_profile` (`entity_app_profile`),
  CONSTRAINT `entity_app_profile_param_ibfk_1` FOREIGN KEY (`app_profile_param_value`) REFERENCES `app_profile_param_value` (`id`),
  CONSTRAINT `entity_app_profile_param_ibfk_2` FOREIGN KEY (`entity_app_profile`) REFERENCES `entity_app_profile` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `entity_level`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `forgot_password` (
  ...
  `token_password` varchar(45) NOT NULL,
  `sent_time` bigint(20) NOT NULL,
  `sent_timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `use_once` varchar(2) NOT NULL DEFAULT 'N',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `heartbeat` (
  ...
  `sequenceAt` varchar(128) DEFAULT NULL,
  `hw_model` varchar(128) DEFAULT NULL,
...
--
-- Table structure for table `heartbeat_alert`
--

DROP TABLE IF EXISTS `heartbeat_alert`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `heartbeat_app_info`
--

DROP TABLE IF EXISTS `heartbeat_app_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `heartbeat_app_info` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `heartbeat_audit`
--

DROP TABLE IF EXISTS `heartbeat_audit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `heartbeat_odometer`
--

DROP TABLE IF EXISTS `heartbeat_odometer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `heartbeat_odometer` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `component` varchar(128) NOT NULL,
  `label` varchar(128) DEFAULT NULL,
  `description` varchar(128) DEFAULT NULL,
  `evaluate` varchar(45) DEFAULT NULL,
  `entity` bigint(20) NOT NULL,
  `name` varchar(128) DEFAULT NULL,
  `occurred` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `heartbeat_response`
--

DROP TABLE IF EXISTS `heartbeat_response`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `heartbeat_response` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `status` int(11) DEFAULT NULL,
  `interval` bigint(10) DEFAULT NULL,
  `debug` tinyint(4) DEFAULT NULL,
  `download_info` bigint(20) DEFAULT NULL,
  `message` varchar(128) DEFAULT NULL,
...
--
-- Table structure for table `rki_info`
--

DROP TABLE IF EXISTS `rki_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rki_info` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `role` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='Stores roles.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `session` (
  ...
  `token` varchar(250) NOT NULL COMMENT 'Session''s security token.',
...
) ENGINE=InnoDB AUTO_INCREMENT=199 DEFAULT CHARSET=utf8 COMMENT='Stores session information.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `signature` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stores signatures.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stores transaction information.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  `email` varchar(128) NOT NULL COMMENT 'User''s email.',
  ...
  `password_expiration` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `require_password_update` tinyint(1) NOT NULL DEFAULT '0',
  `verification_code` varchar(100) DEFAULT NULL,
  `verification_code_expiration` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `two_factor_at` timestamp NOT NULL DEFAULT '1980-01-01 05:00:00',
  `two_factor_freq` int(11) NOT NULL DEFAULT '0',
  `ip_assigned` varchar(45) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='Stores all the system users';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `user_last_password`
--

DROP TABLE IF EXISTS `user_last_password`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_last_password` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Database identification.',
  `user` bigint(20) NOT NULL COMMENT 'The user.',
  `password1` varchar(100) DEFAULT NULL COMMENT 'Last password.',
  `password2` varchar(100) DEFAULT NULL COMMENT 'Last password.',
  `password3` varchar(100) DEFAULT NULL COMMENT 'Last password.',
  `password4` varchar(100) DEFAULT NULL COMMENT 'Last password.',
  `password5` varchar(100) DEFAULT NULL COMMENT 'Last password.',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  UNIQUE KEY `user_UNIQUE` (`user`),
  KEY `User_FK_idx` (`user`),
  CONSTRAINT `User_FK` FOREIGN KEY (`user`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='Stores all the system users last passwords';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `verification_code` (
  `id` int(20) NOT NULL AUTO_INCREMENT COMMENT 'Database identification.',
  `email_id` varchar(50) NOT NULL DEFAULT '' COMMENT 'User''s email.',
  `code` varchar(50) NOT NULL DEFAULT '' COMMENT 'Verification code.',
  `sent_time` bigint(20) NOT NULL COMMENT 'Sent time.',
  `sent_timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Sent timestamp.',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping routines for database 'tms_dev3'
--
...
-- Dump completed on 2018-05-28 17:25:57
