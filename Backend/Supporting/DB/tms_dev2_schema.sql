...
--
-- Host: localhost    Database: tms_dev2
-- ------------------------------------------------------
...
CREATE TABLE `app_file` (
  ...
  CONSTRAINT `AppFile_fk1` FOREIGN KEY (`AppFileFormat`) REFERENCES `app_file_format` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `app_param` (
  ...
  CONSTRAINT `AppParam_fk1` FOREIGN KEY (`EntityLevel`) REFERENCES `entity_level` (`id`),
  CONSTRAINT `AppParam_fk2` FOREIGN KEY (`AppParamFormat`) REFERENCES `app_param_format` (`id`),
...
CREATE TABLE `app_profile_file_value` (
  ...
  CONSTRAINT `AppProfileFileValue_fk0` FOREIGN KEY (`AppProfile`) REFERENCES `app_profile` (`id`),
  CONSTRAINT `AppProfileFileValue_fk1` FOREIGN KEY (`AppFile`) REFERENCES `app_file` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `app_profile_param_value` (
  ...
  CONSTRAINT `AppProfileParamValue_fk0` FOREIGN KEY (`AppProfile`) REFERENCES `app_profile` (`id`),
  CONSTRAINT `AppProfileParamValue_fk1` FOREIGN KEY (`AppParam`) REFERENCES `app_param` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `appliance_app_file_value` (
  ...
  CONSTRAINT `ApplianceAppFileValue_fk1` FOREIGN KEY (`AppProfileFileValue`) REFERENCES `app_profile_file_value` (`AppProfile`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `appliance_app_param_value` (
  ...
  CONSTRAINT `ApplianceAppParamValue_fk1` FOREIGN KEY (`AppProfileParamValue`) REFERENCES `app_profile_param_value` (`AppProfile`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  `require_password_update` tinyint(1) NOT NULL DEFAULT '1',
  ...
  `email` varchar(50) NOT NULL COMMENT 'User''s email.',
  ...
  `ip_assigned` varchar(45) NOT NULL DEFAULT '',
  `ip_last_access` varchar(45) NOT NULL DEFAULT '0.0.0.0',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation date.',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Last update.',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='Stores all the system users';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping routines for database 'tms_dev2'
--
...
-- Dump completed on 2018-03-31  0:59:56
