...
public class MockAppService extends CrudService<App>{
	...
	{	List<Devices> deviceList = mockDeviceService.getSavedList();
		...
		App app = new App("Payment Application","This is Payment Application","1.0",true,mockAppDefaultParamService.getSavedList(),deviceList.get(0),userList.get(0),profileList.get(0));
		...
		app = new App("Gift Card Application","This is Gift Card","2.0",true,listParam1,deviceList.get(1),userList.get(1),profileList.get(1));
		 app.setId(app.getId()+3);
		appDirectory.put(app.getId(), app);
		List<AppDefaultParam> listParam2 = mockAppDefaultParamService.getSavedList().subList(0, 1);
		app = new App("Operating System","This is Operating System","1.4",false,listParam2,deviceList.get(2),userList.get(2),profileList.get(0));
