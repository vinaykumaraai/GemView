...
//@SpringViewDisplay
//@UIScope
public class TwoFactorView extends VerticalLayout implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 1635564334511078896L;
	//public static final String VIEW_NAME = "twofactorauthenticationpage";
	
	private final NavigationManager navigationManager;
	protected VerticalLayout content;
	
	@Autowired
	public TwoFactorView(NavigationManager navigationManager) {
